  ...
  return (
    <div className="space-y-5">
      ...
      {!loading && !loadError && !isCreatingSite && (
        <>
          {sites.length === 0 ? (
            /* Sin sedes — formulario de creación disponible */
            ...
            <>
              ...
              {/* Botón para crear sede adicional */}
              <button
                type="button"
                onClick={() => setIsCreatingSite(true)}
              ...
              {selectedSite && (
                <div className="rounded-lg border border-accent/30 bg-accent/10 px-4 py-3 space-y-1">
                  ...
                  <p className="text-xs text-textSecondary">
                    Capacidad máxima:{' '}
                    <span className="font-bold text-textPrimary">{selectedSite.capacity}</span> personas
                  </p>
                </div>
              )}
              ...
              <div>
                ...
                />
                {exceedsCapacity && (
                  <p className={errorClass}>⚠ Supera la capacidad máxima ({selectedSite.capacity})</p>
                )}
        ...
        <div className="space-y-4 rounded-xl border border-accent/20 bg-accent/5 p-4">
          ...
          <div>
            ...
            <input
              ...
              maxLength={200}
              className={inputClass}
              placeholder="Calle 24 # 34-12, Bogotá"
          ...
          <div>
            ...
            <p className="text-[11px] text-textMuted mb-2">
              Haz clic en el mapa para marcar la ubicación exacta de la sede.
            </p>
            <SiteMapPicker
              value={newSite.location}
              onChange={loc => setNewSite(s => ({ ...s, location: loc }))}
            />
      ...
      {/* Error del backend al crear el evento */}
