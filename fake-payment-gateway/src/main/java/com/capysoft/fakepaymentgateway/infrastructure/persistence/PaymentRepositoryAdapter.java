...
public class PaymentRepositoryAdapter implements PaymentRepository {
    ...
    public Payment save(Payment payment) {
        // Buscar entidad existente por paymentId o crear nueva
        PaymentEntity entity = jpaRepository.findByPaymentId(payment.getPaymentId())
            .orElse(new PaymentEntity());
        
        // Actualizar campos desde el dominio
